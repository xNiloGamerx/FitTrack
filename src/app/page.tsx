  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="p-4 w-full">
        <div className="flex flex-col items-center justify-start gap-3 md:max-w-90 bg-card rounded-2xl">
          {/* w-60 h-60 */}
          ...
          <div className="relative flex items-center justify-end flex-col w-full justify-self-end pb-3">
            ...
            <div className="absolute bg-[#00bfff94] w-12 h-15 bottom-4.5 rounded-lg"></div>
