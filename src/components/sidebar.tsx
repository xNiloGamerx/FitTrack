  ...
  return (
    <nav className="flex flex-col justify-start items-start gap-10 w-70 h-full bg-sidebar p-4">
      ...
      <div className="flex flex-col gap-2 flex-1 w-full">
        <LinkElement Icon={HomeIcon} label="Home" href="/" />
        <LinkElement Icon={Dumbbell} label="Workouts" href="/workouts" />
        <LinkElement Icon={Timer} label="Week" href="/week" />
        <LinkElement Icon={Flame} label="Caloriens" href="/caloriens" />
      </div>
      ...
      <div className="flex flex-col gap-2 justify-center w-full">
        ...
        ></UserLinkElement>
        <LinkElement Icon={Settings} label="Settings" href="/settings" />
      </div>
    </nav>
  );
}
